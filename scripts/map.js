$(window).on('load', function() {
    ...
    for (var i in points) {
      ...
      if (point.Latitude !== '' && point.Longitude !== '') {
        var marker = L.marker([point.Latitude, point.Longitude], {icon: icon})
          .bindPopup(`<b><font size="+1">${point['Name']}</font></b><br>High School:  ${point['Group']}</font></b><br>Program Type: <br>${point['Description']}</a></ba><br>`);
  ...
  function changeAttribution() {
    ...
    var credit = 'View <a href="https://docs.google.com/spreadsheets/d/e/2PACX-1vQH1FSnZRVhlL08DpjHQ24DrZ4IOWtOuSKOfvKB-A2UDQ9CMQr5mhSz7tqKVuIee5uDK66OOyMExr9g/pubhtml" + " target="_blank">data</a>';
